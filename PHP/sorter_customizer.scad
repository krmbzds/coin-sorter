...
coin_1_diameter = 30.0;
// in millimeters.
coin_1_thickness = 2.10;
// The second coin. Remember: this 2nd coin should always be smaller than the 1st coin.
coin_2_diameter = 27.0;
coin_2_thickness = 2.05;
// The 3rd coin.
coin_3_diameter = 25.0;
coin_3_thickness = 2.20;
// 4th coin.
coin_4_diameter = 23.0;
coin_4_thickness = 2.05;
// 5th coin. If you don't need more coins, simply set the remaining to 0.
coin_5_diameter = 20.0;
